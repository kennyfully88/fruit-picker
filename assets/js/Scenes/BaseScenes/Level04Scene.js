...
class Level04Scene extends Scene {
	constructor() {
		super();
		this.name = 'level-04';
		this.gameObjects = [];
		this.player = new Player({ dx: 80, dy: 10 });
		this.fadeInOut = 0;
		...
		this.gameObjects.push(
			...
			new Tree({ dx: 30, dy: 20, dw: 10, dh: 60 }),
			new Fruit({ dx: 30, dy: 10 }),
			new Fruit({ dx: 30, dy: 80 }),
			new Fruit({ dx: 70, dy: 70 }),
			new Fruit({ dx: 80, dy: 80 }),
			new Fruit({ dx: 10, dy: 70 }),
			new Fruit({ dx: 80, dy: 50 }),
			new Basket({ dx: 20, dy: 20 }),
			new Basket({ dx: 40, dy: 30 }),
			new Basket({ dx: 20, dy: 40 }),
			new Basket({ dx: 40, dy: 50 }),
			new Basket({ dx: 20, dy: 60 }),
			new Basket({ dx: 40, dy: 70 }),
			new Monster({ dx: 20, dy: 30 }),
			new Monster({ dx: 40, dy: 60 }),
			new Monster({ dx: 50, dy: 50 }),
			new Monster({ dx: 10, dy: 80 }),
			new Monster({ dx: 80, dy: 40 }),
		);
