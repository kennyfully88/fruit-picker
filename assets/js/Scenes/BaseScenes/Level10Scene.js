...
class Level10Scene extends Scene {
	constructor() {
		super();
		this.name = 'level-10';
		this.gameObjects = [];
		this.player = new Player({ dx: 50, dy: 40 });
		this.fadeInOut = 0;
		...
		this.gameObjects.push(
			...
			new Fruit({ dx: 30, dy: 60 }),
			new Fruit({ dx: 60, dy: 60 }),
			new Fruit({ dx: 10, dy: 80 }),
			new Fruit({ dx: 80, dy: 80 }),
			new Basket({ dx: 30, dy: 40 }),
			new Basket({ dx: 40, dy: 50 }),
			new Basket({ dx: 50, dy: 50 }),
			new Basket({ dx: 60, dy: 40 }),
			new Monster({ dx: 30, dy: 20 }),
			new Monster({ dx: 60, dy: 20 }),
			new Monster({ dx: 20, dy: 30 }),
			new Monster({ dx: 70, dy: 30 }),
			new Monster({ dx: 20, dy: 40 }),
			new Monster({ dx: 70, dy: 40 }),
			new Monster({ dx: 30, dy: 50 }),
			new Monster({ dx: 60, dy: 50 }),
			new Monster({ dx: 40, dy: 60 }),
			new Monster({ dx: 50, dy: 60 }),
			new Fireball({ dx: 10, dy: 10, moveCounterMax: 1 }),
			new Fireball({ dx: 10, dy: 70, moveCounterMax: 1 }),
		);

		gameLogic.currentLevel = 10;
	}
